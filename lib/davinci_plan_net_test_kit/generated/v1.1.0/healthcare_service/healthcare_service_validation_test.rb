...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class HealthcareServiceValidationTest < Inferno::Test
      ...
      id :davinci_plan_net_v110_healthcare_service_validation_test
      title 'HealthcareService resources returned during previous tests conform to the Plan-Net HealthcareService'
      description %(
This test verifies resources returned from the first search conform to
the [Plan-Net HealthcareService](http://hl7.org/fhir/us/davinci-pdex-plan-net/STU1.1/StructureDefinition/plannet-HealthcareService).
