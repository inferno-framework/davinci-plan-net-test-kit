...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class HealthcareServiceNoParamsSearchTest < Inferno::Test
      ...
      title 'Client can identify instances of Plan-Net HealthcareService on the server'
      description %(
...
as described in the "Instance Gathering" section of the group description above.
      ...
      id :davinci_plan_net_v110_healthcare_service_no_params_search_test

      input :davinci_plan_net_v110_healthcare_service_no_params_search_test_ids,
        title: 'ids of Plan-Net HealthcareService instances',
        optional: true,
      ...
      run do
        run_search_no_params_test(davinci_plan_net_v110_healthcare_service_no_params_search_test_ids)
      end
    end
  end
end
