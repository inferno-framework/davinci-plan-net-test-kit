...
as described in the "Instance Gathering" section of the group description above.
      ...
      input :davinci_plan_net_v110_network_no_params_search_test_ids,
        title: 'ids of Plan-Net Network instances',
        optional: true,
      ...
      run do
        run_search_no_params_test(davinci_plan_net_v110_network_no_params_search_test_ids)
      end
    end
  end
end
