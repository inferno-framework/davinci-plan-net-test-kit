...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class OrganizationReverseChainOrgAffilParticipatingOrganizationSpecialtySearchTest < Inferno::Test
      ...
      input :org_affil_participating_organization_specialty_input,
      ...
      def properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: [],
          input_name: 'org_affil_participating_organization_specialty_input',
