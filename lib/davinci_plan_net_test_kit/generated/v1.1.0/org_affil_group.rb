require_relative 'org_affil/org_affil_no_params_search_test'
require_relative 'org_affil/org_affil_read_test'
require_relative 'org_affil/org_affil_primary_organization_search_test'
require_relative 'org_affil/org_affil_participating_organization_search_test'
require_relative 'org_affil/org_affil_location_search_test'
require_relative 'org_affil/org_affil_service_search_test'
require_relative 'org_affil/org_affil_network_search_test'
require_relative 'org_affil/org_affil_endpoint_search_test'
require_relative 'org_affil/org_affil_role_search_test'
require_relative 'org_affil/org_affil_specialty_search_test'
require_relative 'org_affil/org_affil_id_search_test'
require_relative 'org_affil/org_affil_lastupdated_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_primary_organization_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_participating_organization_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_location_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_service_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_endpoint_search_test'
require_relative 'org_affil/org_affil_include_organization_affiliation_network_search_test'
require_relative 'org_affil/org_affil_forward_chain_primary_organization_type_search_test'
require_relative 'org_affil/org_affil_forward_chain_primary_organization_address_search_test'
require_relative 'org_affil/org_affil_forward_chain_primary_organization_name_search_test'
require_relative 'org_affil/org_affil_forward_chain_primary_organization_partof_search_test'
require_relative 'org_affil/org_affil_forward_chain_participating_organization_type_search_test'
require_relative 'org_affil/org_affil_forward_chain_participating_organization_address_search_test'
require_relative 'org_affil/org_affil_forward_chain_participating_organization_name_search_test'
require_relative 'org_affil/org_affil_forward_chain_participating_organization_partof_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_address_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_address_postalcode_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_address_city_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_address_state_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_organization_search_test'
require_relative 'org_affil/org_affil_forward_chain_location_type_search_test'
require_relative 'org_affil/org_affil_forward_chain_service_service_category_search_test'
require_relative 'org_affil/org_affil_forward_chain_service_organization_search_test'
require_relative 'org_affil/org_affil_forward_chain_service_location_search_test'
require_relative 'org_affil/org_affil_forward_chain_network_name_search_test'
require_relative 'org_affil/org_affil_forward_chain_network_partof_search_test'
require_relative 'org_affil/org_affil_forward_chain_endpoint_organization_search_test'
require_relative 'org_affil/org_affil_validation_test'
require_relative 'org_affil/org_affil_must_support_test'
require_relative 'org_affil/org_affil_reference_resolution_test'

module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class OrgAffilGroup < Inferno::TestGroup
...
read succeeds.
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, 'org_affil', 'metadata.yml'), aliases: true))
      end
  
      test from: :davinci_plan_net_v110_org_affil_no_params_search_test
      test from: :davinci_plan_net_v110_org_affil_read_test
      test from: :davinci_plan_net_v110_org_affil_primary_organization_search_test
      test from: :davinci_plan_net_v110_org_affil_participating_organization_search_test
      test from: :davinci_plan_net_v110_org_affil_location_search_test
      test from: :davinci_plan_net_v110_org_affil_service_search_test
      test from: :davinci_plan_net_v110_org_affil_network_search_test
      test from: :davinci_plan_net_v110_org_affil_endpoint_search_test
      test from: :davinci_plan_net_v110_org_affil_role_search_test
      test from: :davinci_plan_net_v110_org_affil_specialty_search_test
      test from: :davinci_plan_net_v110_org_affil__id_search_test
      test from: :davinci_plan_net_v110_org_affil__lastUpdated_search_test
      test from: :davinci_plan_net_v110_include_org_affil_organization_affiliation_primary_organization_search_test
      test from: :davinci_plan_net_v110_include_org_affil_organization_affiliation_participating_organization_search_test
      test from: :davinci_plan_net_v110_include_org_affil_organization_affiliation_location_search_test
