...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class OrgAffilIncludeOrganizationAffiliationParticipatingOrganizationSearchTest < Inferno::Test
      ...
      description %(
        A server SHALL be capable of supporting _includes on search parameter OrganizationAffiliation:participating-organization.

        This test will perform a search on OrganizationAffiliation with _include=OrganizationAffiliation:participating-organization 
