...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class PractitionerReverseChainPractitionerRolePractitionerNetworkSearchTest < Inferno::Test
      ...
      title 'Server capable of reverse chaining through PractitionerRole\'s network element'
      description %(
        ...
        run from the suite level, or the "\'network\' value from a PractitionerRole 
        ...
        on the PractitionerRole resource type using the same network search 
      ...
      input :practitioner_role_practitioner_network_input,
        title: '\'network\' value from a PractitionerRole instance with \'practitioner\' populated',
        description: 'Single value from the \'network\' element of a PractitionerRole
        on an instance that also references a Practitioner instance in its \'practitioner\' element to be used for test 
        \'Server capable of reverse chaining through PractitionerRole\'s network element\' when run at the group level.',
        optional: true
