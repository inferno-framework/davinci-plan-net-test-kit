...
is expected to conform to the [Plan-Net InsurancePlan](http://hl7.org/fhir/us/davinci-pdex-plan-net/STU1.1/StructureDefinition/plannet-InsurancePlan). Each element is checked 
...
read succeeds.
      ...
      test from: :davinci_plan_net_v110_insurance_plan_no_params_search_test
      test from: :davinci_plan_net_v110_insurance_plan_read_test
      test from: :davinci_plan_net_v110_insurance_plan_administered_by_search_test
      test from: :davinci_plan_net_v110_insurance_plan_owned_by_search_test
      test from: :davinci_plan_net_v110_insurance_plan_coverage_area_search_test
      test from: :davinci_plan_net_v110_insurance_plan_name_search_test
      test from: :davinci_plan_net_v110_insurance_plan_plan_type_search_test
      test from: :davinci_plan_net_v110_insurance_plan_identifier_search_test
      test from: :davinci_plan_net_v110_insurance_plan__id_search_test
      test from: :davinci_plan_net_v110_insurance_plan__lastUpdated_search_test
      test from: :davinci_plan_net_v110_insurance_plan_type_search_test
      ...
      test from: :davinci_plan_net_v110_forward_chain_insurance_plan_administered_by_name_search_test
      test from: :davinci_plan_net_v110_forward_chain_insurance_plan_administered_by_partof_search_test
      test from: :davinci_plan_net_v110_forward_chain_insurance_plan_owned_by_name_search_test
      test from: :davinci_plan_net_v110_forward_chain_insurance_plan_owned_by_partof_search_test
      test from: :davinci_plan_net_v110_insurance_plan_validation_test
      test from: :davinci_plan_net_v110_insurance_plan_must_support_test
      test from: :davinci_plan_net_v110_insurance_plan_reference_resolution_test
    end
  end
end
