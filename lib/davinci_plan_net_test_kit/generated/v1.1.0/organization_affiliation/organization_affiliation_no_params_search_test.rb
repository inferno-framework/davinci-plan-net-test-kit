...
as described in the "Instance Gathering" section of the group description above.
      ...
      id :davinci_plan_net_v110_organization_affiliation_no_params_search_test

      input :davinci_plan_net_v110_organization_affiliation_no_params_search_test_ids,
      ...
      run do
        run_search_no_params_test(davinci_plan_net_v110_organization_affiliation_no_params_search_test_ids)
      end
    end
  end
end
