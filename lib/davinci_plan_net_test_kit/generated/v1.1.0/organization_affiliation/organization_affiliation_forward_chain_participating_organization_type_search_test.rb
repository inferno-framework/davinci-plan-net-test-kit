...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class OrganizationAffiliationForwardChainParticipatingOrganizationTypeSearchTest < Inferno::Test
      include DaVinciPlanNetTestKit::SearchTest

      title 'Server capable of forward chaining with participating-organization.type'
      description %(
        A server SHALL be capable of supporting chaining for type through the search parameter participating-organization
        for the Organization_affiliation profile.

        This test will perform a search with participating-organization.type using a value
      ...
      id :davinci_plan_net_v110_forward_chain_participating_organization_type_search_test
