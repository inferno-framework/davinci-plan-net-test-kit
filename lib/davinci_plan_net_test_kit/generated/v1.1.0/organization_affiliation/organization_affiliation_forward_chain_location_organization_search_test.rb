...
module DaVinciPlanNetTestKit
  module DaVinciPlanNetV110
    class OrganizationAffiliationForwardChainLocationOrganizationSearchTest < Inferno::Test
      ...
      description %(
        ...
        This test will perform a search with location.organization using a value
