...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class LocationOrganizationAddressForwardChainSearchTest < Inferno::Test
      include DaVinciPDEXPlanNetTestKit::SearchTest

      title 'Server returns Location that populate the address field of a Organization instance'
      description %(
