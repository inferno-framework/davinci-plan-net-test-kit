...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class LocationOrganizationNameForwardChainSearchTest < Inferno::Test
      include DaVinciPDEXPlanNetTestKit::SearchTest

      title 'Server returns Location that populate the name field of a Organization instance
