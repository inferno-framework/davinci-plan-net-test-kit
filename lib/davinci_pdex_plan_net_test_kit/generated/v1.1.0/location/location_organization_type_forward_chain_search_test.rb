...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class LocationOrganizationTypeForwardChainSearchTest < Inferno::Test
      include DaVinciPDEXPlanNetTestKit::SearchTest

      title 'Server returns Location that populate the type field of a Organization instance'
      description %(
