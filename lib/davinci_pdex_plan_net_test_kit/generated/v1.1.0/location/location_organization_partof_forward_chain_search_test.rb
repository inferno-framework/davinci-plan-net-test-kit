...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class LocationOrganizationPartofForwardChainSearchTest < Inferno::Test
      include DaVinciPDEXPlanNetTestKit::SearchTest

      title 'Server returns Location that populate the partof field of a Organization instance'
      description %(
