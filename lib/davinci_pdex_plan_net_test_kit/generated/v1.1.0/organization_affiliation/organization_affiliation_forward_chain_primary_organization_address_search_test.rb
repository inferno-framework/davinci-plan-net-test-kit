...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class OrganizationAffiliationForwardChainPrimaryOrganizationAddressSearchTest < Inferno::Test
      include DaVinciPDEXPlanNetTestKit::SearchTest

      title 'Server capable of forward chaining with primary-organization.address'
      description %(
        A server SHALL be capable of supporting chaining for address through the search parameter primary-organization
        for the Organization_affiliation profile.

        This test will perform a search with primary-organization.address using a value
      ...
      id :davinci_plan_net_v110_forward_chain_primary_organization_address_search_test
