...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class OrganizationAffiliationForwardChainPrimaryOrganizationTypeSearchTest < Inferno::Test
      ...
      description %(
        ...
        This test will perform a search with primary-organization.type and
        will pass if an OrganizationAffiliation resource is found in the response.
      )

      id :davinci_plan_net_v110_forward_chain_primary_organization_type_search_test
