...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class OrganizationAffiliationOrganizationaffiliationNetworkIncludeSearchTest < Inferno::Test
      ...
      id :davinci_plan_net_v110_v110_organization_affiliation_organizationaffiliation_network_include_search_test
      input :organizationaffiliation_network_input,
      ...
      def properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: [],
          input_name: 'organizationaffiliation_network_input',
