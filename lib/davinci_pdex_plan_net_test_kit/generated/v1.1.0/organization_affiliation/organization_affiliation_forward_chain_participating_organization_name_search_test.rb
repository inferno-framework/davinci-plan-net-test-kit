...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class OrganizationAffiliationForwardChainParticipatingOrganizationNameSearchTest < Inferno::Test
      ...
      description %(
        ...
        This test will perform a search with participating-organization.name and
