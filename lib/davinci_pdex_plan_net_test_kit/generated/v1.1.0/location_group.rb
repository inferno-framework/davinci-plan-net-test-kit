...
require_relative 'location/location_healthcareservice_location_search_test'
require_relative 'location/location_insuranceplan_coverage_area_search_test'
require_relative 'location/location_organizationaffiliation_location_search_test'
require_relative 'location/location_practitionerrole_location_search_test'
...
The US Core Plan-Net Location sequence verifies that the system under test is
able to provide correct responses for Location queries. These queries
must contain resources conforming to the Plan-Net Location as
