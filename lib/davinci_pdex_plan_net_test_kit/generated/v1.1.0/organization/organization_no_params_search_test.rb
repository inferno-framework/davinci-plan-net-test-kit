...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class OrganizationNoParamsSearchTest < Inferno::Test
...
[Plan Net Server CapabilityStatement](http://hl7.org/fhir/us/davinci-pdex-plan-net/CapabilityStatement/plan-net)
      ...
      input :davinci_pdex_plan_net_v110_plannet_organization_no_params_search_test_ids,
      ...
      run do
        run_search_no_params_test(davinci_pdex_plan_net_v110_plannet_organization_no_params_search_test_ids)
      end
    end
  end
end
