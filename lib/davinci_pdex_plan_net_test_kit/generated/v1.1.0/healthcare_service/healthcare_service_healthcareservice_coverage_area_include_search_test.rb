...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class HealthcareServiceHealthcareserviceCoverageAreaIncludeSearchTest < Inferno::Test
      ...
      id :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_coverage_area_include_search_test
      input :healthcareservice_coverage_area_input,
      ...
      def properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: [],
          input_name: 'healthcareservice_coverage_area_input',
