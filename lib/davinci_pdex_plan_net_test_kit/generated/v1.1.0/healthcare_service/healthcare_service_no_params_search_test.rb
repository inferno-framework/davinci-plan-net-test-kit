...
[US Core Server CapabilityStatement](http://hl7.org/fhir/us/core//CapabilityStatement-us-core-server.html)
      ...
      input :davinci_pdex_plan_net_v110_healthcare_service_no_params_search_test_ids,
        title: 'Ids of instances of Plan-Net HealthcareService',
        optional: true,
      ...
      run do
        run_search_no_params_test(davinci_pdex_plan_net_v110_healthcare_service_no_params_search_test_ids)
      end
    end
  end
end
