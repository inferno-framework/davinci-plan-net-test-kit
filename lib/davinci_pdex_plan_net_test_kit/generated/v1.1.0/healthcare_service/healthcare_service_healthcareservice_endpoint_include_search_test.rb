...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class HealthcareServiceHealthcareserviceEndpointIncludeSearchTest < Inferno::Test
      ...
      id :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_endpoint_include_search_test
      input :healthcareservice_endpoint_input,
      ...
      def properties
        @properties ||= SearchTestProperties.new(
          ...
          search_param_names: [],
          input_name: 'healthcareservice_endpoint_input',
