...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetServerV110
    class DaVinciPDEXPlanNetServerTestSuite < Inferno::TestSuite
      title 'DaVinci PDEX Plan Net v1.1.0 Server Test Suite'
      description %(
        ...
        feedback](https://gitlab.mitre.org/inferno/davinci-pdex-plan-net-test-kit/-/issues) 
        ...
        `Da Vinci PDEX Plan Net Reference Server` preset in the upper left.
      ...
      links [
        {
          label: 'Report Issue',
          url: 'https://gitlab.mitre.org/inferno/davinci-pdex-plan-net-test-kit/-/issues'
        },
        {
          label: 'Source Code',
          url: 'https://gitlab.mitre.org/inferno/davinci-pdex-plan-net-test-kit'
        }
      ]

      id :davinci_pdex_plan_net_server_v110
