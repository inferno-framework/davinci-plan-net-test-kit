...
require_relative 'plannet_organization/plannet_organization_revinclude_endpoint_organization_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_healthcareservice_organization_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_insuranceplan_administered_by_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_insuranceplan_owned_by_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_organizationaffiliation_primary_organization_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_practitionerrole_organization_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_practitionerrole_network_search_test'
require_relative 'plannet_organization/plannet_organization_revinclude_organizationaffiliation_participating_organization_search_test'
...
read succeeds.
      ...
      test from: :us_core_v110_plannet_organization_revinclude_Endpoint_organization_search_test
      test from: :us_core_v110_plannet_organization_revinclude_HealthcareService_organization_search_test
      test from: :us_core_v110_plannet_organization_revinclude_InsurancePlan_administered_by_search_test
      test from: :us_core_v110_plannet_organization_revinclude_InsurancePlan_owned_by_search_test
      test from: :us_core_v110_plannet_organization_revinclude_OrganizationAffiliation_primary_organization_search_test
      test from: :us_core_v110_plannet_organization_revinclude_PractitionerRole_organization_search_test
      test from: :us_core_v110_plannet_organization_revinclude_PractitionerRole_network_search_test
      test from: :us_core_v110_plannet_organization_revinclude_OrganizationAffiliation_participating_organization_search_test
