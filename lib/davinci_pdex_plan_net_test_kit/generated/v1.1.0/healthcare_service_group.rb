...
require_relative 'healthcare_service/healthcare_service_healthcareservice_location_include_search_test'
require_relative 'healthcare_service/healthcare_service_healthcareservice_coverage_area_include_search_test'
require_relative 'healthcare_service/healthcare_service_healthcareservice_organization_include_search_test'
require_relative 'healthcare_service/healthcare_service_healthcareservice_endpoint_include_search_test'
require_relative 'healthcare_service/healthcare_service_practitionerrole_service_revinclude_search_test'
require_relative 'healthcare_service/healthcare_service_organizationaffiliation_service_revinclude_search_test'
...
The US Core Plan-Net HealthcareService sequence verifies that the system under test is
able to provide correct responses for HealthcareService queries. These queries
must contain resources conforming to the Plan-Net HealthcareService as
...
read succeeds.
      ...
      test from: :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_location_include_search_test
      test from: :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_coverage_area_include_search_test
      test from: :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_organization_include_search_test
      test from: :davinci_plan_net_v110_v110_healthcare_service_healthcareservice_endpoint_include_search_test
      test from: :davinci_plan_net_v110_v110_healthcare_service_practitionerrole_service_revinclude_search_test
      test from: :davinci_plan_net_v110_v110_healthcare_service_organizationaffiliation_service_revinclude_search_test
