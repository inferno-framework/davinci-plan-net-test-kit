...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class PractitionerReverseChainPractitionerRolePractitionerNetworkSearchTest < Inferno::Test
      ...
      title 'Server capable of reverse chaining through PractitionerRole\'s network field'
      description %(
        A server SHALL support reverse chaining.

        Test will use the query _has:PractitionerRole:practitioner:network to test
