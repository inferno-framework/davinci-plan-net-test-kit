...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class PractitionerNoParamsSearchTest < Inferno::Test
      ...
      title 'Client can identify instances of Plan-Net Practitioner on the server'
      description %(
...
[Plan Net Server CapabilityStatement](http://hl7.org/fhir/us/davinci-pdex-plan-net/CapabilityStatement/plan-net)
      ...
      input :davinci_pdex_plan_net_v110_practitioner_no_params_search_test_ids,
        title: 'Ids of instances of Plan-Net Practitioner',
        optional: true,
      ...
      run do
        run_search_no_params_test(davinci_pdex_plan_net_v110_practitioner_no_params_search_test_ids)
      end
    end
  end
end
