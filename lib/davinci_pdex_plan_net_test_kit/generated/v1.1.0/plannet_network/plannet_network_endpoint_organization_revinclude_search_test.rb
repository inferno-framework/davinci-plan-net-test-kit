...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class PlannetNetworkEndpointOrganizationRevincludeSearchTest < Inferno::Test
      ...
      id :davinci_plan_net_v110_plannet_network_endpoint_organization_revinclude_search_test
