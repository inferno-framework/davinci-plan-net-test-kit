...
module DaVinciPDEXPlanNetTestKit
  module DaVinciPDEXPlanNetV110
    class NetworkRevincludePractitionerRoleOrganizationSearchTest < Inferno::Test
      ...
      description %(
        ...
        This test will perform a search with _revinclude=PractitionerRole:organization and
        will pass if a PractitionerRole resource is found in the response.
      )

      id :davinci_plan_net_v110_revinclude_network_practitioner_role_organization_search_test
