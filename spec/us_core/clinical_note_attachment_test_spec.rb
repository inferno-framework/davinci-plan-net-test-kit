require_relative '../../lib/davinci_pdex_plan_net_test_kit/custom_groups/clinical_note_attachment_test'

RSpec.describe DaVinciPDEXPlanNetTestKit::ClinicalNoteAttachmentTest do
