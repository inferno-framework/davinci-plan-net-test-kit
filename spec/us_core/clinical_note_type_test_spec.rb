require_relative '../../lib/davinci_pdex_plan_net_test_kit/custom_groups/clinical_note_type_test'

RSpec.describe DaVinciPDEXPlanNetTestKit::ClinicalNoteTypeTest do
  let(:url) { 'http://example.com/fhir' }
  let(:patient_id) { '85' }
  let(:test_scratch) { {} }
  let(:test_class) do
    Class.new(DaVinciPDEXPlanNetTestKit::ClinicalNoteTypeTest) do
