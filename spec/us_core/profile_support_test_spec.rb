require_relative '../../lib/davinci_pdex_plan_net_test_kit/custom_groups/capability_statement/profile_support_test'

RSpec.describe DaVinciPDEXPlanNetTestKit::ProfileSupportTest do
