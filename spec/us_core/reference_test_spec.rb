RSpec.describe DaVinciPDEXPlanNetTestKit::ReferenceResolutionTest do
  ...
  describe 'reference validation with target profiles' do
    let(:test_class) do
      Class.new(DaVinciPDEXPlanNetTestKit::USCoreV400::DiagnosticReportNoteReferenceResolutionTest) do
        fhir_client { url :url }
        input :url
      end
    end
  ...
  describe 'reference validation without target profile' do
    let(:test_class) do
      Class.new(DaVinciPDEXPlanNetTestKit::USCoreV311::DocumentReferenceReferenceResolutionTest) do
        fhir_client { url :url }
        input :url
      end
    end
