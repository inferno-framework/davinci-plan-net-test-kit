RSpec.describe DaVinciPDEXPlanNetTestKit::MustSupportTest do
  ...
  describe 'must support test for slices' do
    ...
    context 'slicing with type' do
      let(:test_class) { DaVinciPDEXPlanNetTestKit::USCoreV400::SmokingstatusMustSupportTest }
      let(:observation) {
    ...
    context 'slicing with requiredBinding' do
      context 'Condition ProblemsHealthConcerns' do
        let(:test_class) { DaVinciPDEXPlanNetTestKit::USCoreV501::ConditionProblemsHealthConcernsMustSupportTest }
        let(:condition) {
          FHIR::Condition.new(
            extension: [
              {
      ...
      context 'MedicationRequest' do
        let(:test_class) { DaVinciPDEXPlanNetTestKit::USCoreV501::MedicationRequestMustSupportTest }
